...
# 依存ライブラリ展開
execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${BINARY_DIR}/o/sdl3     ar -x ${SDL3_LIB})
execute_process(COMMAND ${CMAKE_COMMAND} -E chdir ${BINARY_DIR}/o/yaml-cpp ar -x ${YAML_CPP_LIB})

# 全.oファイルを再帰的に検索
file(GLOB_RECURSE OBJECTS "${BINARY_DIR}/o/*.o")

# 統合アーカイブ作成
execute_process(COMMAND ar -rc ${BINARY_DIR}/liborgestatic.a ${OBJECTS} ${ORGE_OBJECTS})
