...
if(ORGE_STATIC)
	...
	if(SDL3_PC_FOUND)
		# SDL3_PC_STATIC_LIBRARIESからSDL3-static以外（Windowsシステムライブラリ）を抽出
		list(REMOVE_ITEM SDL3_PC_STATIC_LIBRARIES "SDL3-static")
		string(REPLACE ";" ".lib " ORGE_PC_LIBS_PRIVATE "${SDL3_PC_STATIC_LIBRARIES}")
		set(ORGE_PC_LIBS_PRIVATE "${ORGE_PC_LIBS_PRIVATE}.lib")
	else()
