...
if(ORGE_STATIC)
	...
	if(SDL3_PC_FOUND)
		message(STATUS "SDL3_PC_FOUND: ${SDL3_PC_FOUND}")
		message(STATUS "SDL3_PC_LIBRARIES: ${SDL3_PC_LIBRARIES}")
		message(STATUS "SDL3_PC_LIBRARY_DIRS: ${SDL3_PC_LIBRARY_DIRS}")
		message(STATUS "SDL3_PC_LDFLAGS: ${SDL3_PC_LDFLAGS}")
		message(STATUS "SDL3_PC_LDFLAGS_OTHER: ${SDL3_PC_LDFLAGS_OTHER}")
		message(STATUS "SDL3_PC_INCLUDE_DIRS: ${SDL3_PC_INCLUDE_DIRS}")
		message(STATUS "SDL3_PC_CFLAGS: ${SDL3_PC_CFLAGS}")
		message(STATUS "SDL3_PC_CFLAGS_OTHER: ${SDL3_PC_CFLAGS_OTHER}")
		message(STATUS "SDL3_PC_STATIC_LIBRARIES: ${SDL3_PC_STATIC_LIBRARIES}")
		message(STATUS "SDL3_PC_STATIC_LIBRARY_DIRS: ${SDL3_PC_STATIC_LIBRARY_DIRS}")
		message(STATUS "SDL3_PC_STATIC_LDFLAGS: ${SDL3_PC_STATIC_LDFLAGS}")
		message(STATUS "SDL3_PC_STATIC_LDFLAGS_OTHER: ${SDL3_PC_STATIC_LDFLAGS_OTHER}")
		message(STATUS "SDL3_PC_STATIC_INCLUDE_DIRS: ${SDL3_PC_STATIC_INCLUDE_DIRS}")
		message(STATUS "SDL3_PC_STATIC_CFLAGS: ${SDL3_PC_STATIC_CFLAGS}")
		message(STATUS "SDL3_PC_STATIC_CFLAGS_OTHER: ${SDL3_PC_STATIC_CFLAGS_OTHER}")
